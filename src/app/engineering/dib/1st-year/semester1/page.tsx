...
export default function DIBFirstYearSemester1Page() {
  const semesterData = dibCycle.years[0].semesters[0];
    ...
    <div className="space-y-8">
      ...
      <section className="text-center space-y-4 py-8">
        <div className="flex items-center justify-center gap-2">
          ...
          <h1 className="text-4xl font-bold tracking-tight">D.I.B. - 1ère Année - Semestre 1</h1>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Premier semestre du cycle d'ingénieur D.I.B. - Fondements des infrastructures
        </p>
      </section>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Le premier semestre de la première année du cycle d'ingénieur D.I.B. pose les 
              fondements essentiels pour la conception et la réalisation des infrastructures 
              de base. Les étudiants acquièrent les connaissances théoriques et pratiques 
              nécessaires en résistance des matériaux, mécanique des sols et structures.
            </p>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Statique, dynamique, pertes de charge
                </p>
              </div>
            </CardContent>
          </Card>
